...
export const OfflineSalesColumns = [
    ...
    },
    {
        ...
        render: (text, record) => {
            ...
            return (
                <span>
                    {timeFlag && propClass && <SvgIcon iconClass="arrow" propClass={propClass} />}
    ...
    const salesColumns = [
        ...
        },
        {
            ...
            render: (text, record) => {
                ...
                return (
                    <span>
                        {propClass && <SvgIcon iconClass="arrow" propClass={propClass} />}
                        {percentConversion(+value)}
                    </span>
                );
            }
    ...
    const regionColumns = [
        ...
        },
        {
            ...
            render: (text, record) => {
                ...
                return (
                    <span>
                        {record.time === '环比' && propClass && <SvgIcon iconClass="arrow" propClass={propClass} />}
                        {percentConversion(+value)}
                    </span>
                );
            }
